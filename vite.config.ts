...
const appFlowOverrides = (): Plugin => ({
  ...
  transform(code, id) {
    ...
    return code
      ...
      .replace("{page === 'manual' && <ManualEntry onAdd={addFood} />}", "{page === 'manual' && <FoodLogHub onAdd={addFood} />}")
